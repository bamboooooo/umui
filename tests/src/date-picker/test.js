    ...
    describe('function测试', function () {
        ...
        describe('DatePicker-onOk()方法测试', function () {
            ...
            it('--------------_getDefaultMinDate()方法测试------------------', function () {
                ...
                expect(value.toString()).to.be.equal(new Date('1950-01-01 00:00').toString());
            });
            ...
            it('--------------_getDefaultMaxDate()方法测试------------------', function () {
                ...
                expect(value.toString()).to.be.equal(new Date('2030-12-31 23:59:00').toString());
            });
            ...
            it('--------------_getDateData()方法测试------------------', function () {
                ...
                expect(value[0].props.children[0].value).to.be.equal('1950');
            ...
            it('--------------_getValueCols()方法测试------------------', function () {
                ...
                expect(value.value.toString()).to.be.equal(['1950', '0', '1'].toString());
            });
