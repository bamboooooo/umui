...
describe('FloatButton组件测试', function () {
    describe('props测试', function() {
        ...
        describe('FloatButton-props测试', function () {
            it('porps测试', function () {
                ...
                const floatButton = TestUtils.renderIntoDocument(<FloatButton id="flybutton" className="to-fly"
                                                                              move={true}
                                                                              img="http://172.17.21.139:10080/uploads/user/avatar/6/avatar.png"
                                                                              text="浮动按钮"/>);
